...
<h1 class="wp-block-heading has-text-align-center has-x-large-font-size">Y N M</h1>
<!-- /wp:heading -->
...
<p class="has-text-align-center">Wonderful Products - AFFORDABLE PRICES </p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image alignwide size-full is-style-rounded"><img src="https://younmeresale.com/shop/wp-content/uploads/2024/04/Screenshot-from-2024-04-03-21-43-38.png" alt="" class="wp-image-38"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading has-text-align-center is-style-asterisk">FaceBook </h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><strong>MESSAGE</strong> us on <strong>FaceBook</strong> &amp; View our latest products</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:html -->
</br></br><div style="margin-top:0;margin-bottom:0;height:var(--wp--preset--spacing--40)" aria-hidden="true" class="wp-block-spacer"><center><iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FYOUnME.resale&width=450&layout&action&size&share=true&height=35&appId" width="450" height="35" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe></<center></div>
<!-- /wp:html -->
...
<div class="wp-block-column"><!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"className":"is-style-asterisk","fontSize":"medium","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-center is-style-asterisk has-body-font-family has-medium-font-size" style="font-style:normal;font-weight:600">FB MESSENGER</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Send us a <a href="http://m.me/YOUnME.resale" data-type="link" data-id="http://m.me/YOUnME.resale"><strong>Message</strong></a> </p>
<!-- /wp:paragraph -->

<!-- wp:html -->
<center><figure class="wp-block-image size-large"><a href="http://m.me/YOUnME.resale" target="_blank"><img src="https://younmeresale.com/shop/wp-content/uploads/2024/04/messenger-icon.png" alt=""/></a></figure></center>
<!-- /wp:html --></div>
<!-- /wp:column -->

<!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}}} -->
<div class="wp-block-column"><!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"className":"is-style-asterisk","fontSize":"medium","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-center is-style-asterisk has-body-font-family has-medium-font-size" style="font-style:normal;font-weight:600">FaceBook</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Visit us on <a href="https://www.facebook.com/YOUnME.resale"><strong>FaceBook</strong></a> or attend a onsite sale</p>
<!-- /wp:paragraph -->

<!-- wp:html -->
<center><figure class="wp-block-image size-large"><a href="https://www.facebook.com/YOUnME.resale" target="_blank"><img src="https://younmeresale.com/shop/wp-content/uploads/2024/04/facebook-icon.png" alt=""/></a></figure></center>
<!-- /wp:html --></div>
<!-- /wp:column -->

<!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}}} -->
<div class="wp-block-column"><!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"className":"is-style-asterisk","fontSize":"medium","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-center is-style-asterisk has-body-font-family has-medium-font-size" style="font-style:normal;font-weight:600">EBay</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Our <a href="https://www.ebay.com/usr/iterationlinc"><strong>EBAY</strong></a> Shop  - bid on products</p>
<!-- /wp:paragraph -->

<!-- wp:html -->
<center><figure class="wp-block-image size-large"><a href="https://www.ebay.com/usr/iterationlinc" target="_blank"><img src="https://younmeresale.com/shop/wp-content/uploads/2024/04/ebay-icon.png" alt=""/></a></figure></center>
<!-- /wp:html --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<h3 class="wp-block-heading has-text-align-left is-style-asterisk has-body-font-family has-medium-font-size" style="font-style:normal;font-weight:600"></h3>
<!-- /wp:heading -->
...
<!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}}} -->
<div class="wp-block-column"><!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"className":"is-style-asterisk","fontSize":"medium","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-center is-style-asterisk has-body-font-family has-medium-font-size" style="font-style:normal;font-weight:600">PoshMark</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Our <a href="https://poshmark.com/closet/younmeresale"><strong>PoshMark</strong></a> Shop - Clothing Lingerie More</p>
<!-- /wp:paragraph -->

<!-- wp:html -->
<center><figure class="wp-block-image size-large"><a href="https://poshmark.com/closet/younmeresale" target="_blank"><img src="https://younmeresale.com/shop/wp-content/uploads/2024/04/poshmark-icon.png" alt=""/></a></figure>
</center>
<!-- /wp:html --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-large is-style-rounded"><img src="https://younmeresale.com/shop/wp-content/themes/twentytwentyfour/assets/images/tourist-and-building.webp" alt="Tourist taking photo of a building"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"is-style-rounded"} -->
<figure class="wp-block-image size-large is-style-rounded"><img src="https://younmeresale.com/shop/wp-content/themes/twentytwentyfour/assets/images/windows.webp" alt="Windows of a building in Nuremberg, Germany"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
